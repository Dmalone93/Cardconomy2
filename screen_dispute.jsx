    ...
    return (
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: TD.bg }}>
        <div style={{ padding: '14px 14px 12px', background: TD.surface, borderBottom: '1px solid var(--line)', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 18 }}>Report an Issue</span>
        </div>
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', textAlign: 'center' }}>
          ...
          <h2 style={{ margin: '0 0 8px', fontFamily: TD.sans, fontWeight: 700, fontSize: 22 }}>Claim submitted</h2>
    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: TD.bg }}>
      ...
      <div className="noscroll" style={{ flex: 1, overflow: 'auto', padding: '16px 16px 100px' }}>
        ...
        <div style={{ background: TD.surface, borderRadius: 14, padding: 14, marginBottom: 14, boxShadow: '0 1px 3px rgba(20,24,40,0.05)' }}>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 11, letterSpacing: 0.8, color: TD.muted, textTransform: 'uppercase', marginBottom: 4 }}>Order Reference</div>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 15 }}>Order #CC-20240618-042</div>
        </div>

        {/* issue type */}
        <div style={{ background: TD.surface, borderRadius: 14, padding: 14, marginBottom: 14, boxShadow: '0 1px 3px rgba(20,24,40,0.05)' }}>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 11, letterSpacing: 0.8, color: TD.muted, textTransform: 'uppercase', marginBottom: 10 }}>What went wrong?</div>
        ...
        {/* description */}
        <div style={{ background: TD.surface, borderRadius: 14, padding: 14, marginBottom: 14, boxShadow: '0 1px 3px rgba(20,24,40,0.05)' }}>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 11, letterSpacing: 0.8, color: TD.muted, textTransform: 'uppercase', marginBottom: 8 }}>Description</div>
          <textarea
            value={description}
        ...
        {/* photo upload */}
        <div style={{ background: TD.surface, borderRadius: 14, padding: 14, marginBottom: 14, boxShadow: '0 1px 3px rgba(20,24,40,0.05)' }}>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 11, letterSpacing: 0.8, color: TD.muted, textTransform: 'uppercase', marginBottom: 10 }}>Photos</div>
        ...
        <div style={{ background: TD.surface, borderRadius: 14, padding: 14, marginBottom: 20, boxShadow: '0 1px 3px rgba(20,24,40,0.05)' }}>
          <div style={{ fontFamily: TD.sans, fontWeight: 700, fontSize: 11, letterSpacing: 0.8, color: TD.muted, textTransform: 'uppercase', marginBottom: 10 }}>Preferred Resolution</div>
          <div style={{ display: 'flex', gap: 10 }}>
