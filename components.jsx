...
function Logo({ size = 28, color = 'currentColor', style = {} }) {
  const h = Math.round(size * 52 / 55);
  return (
    <svg width={size} height={h} viewBox="0 0 55 52" fill="none" style={{ color, display: 'block', ...style }}>
      <path d="M2.05237 0.866828L25.3958 14.3542H9.93751C9.3277 14.3542 8.83334 14.8485 8.83334 15.4583V36.4375C8.83334 37.0473 9.32769 37.5417 9.93751 37.5417H25.3958L2.05237 51.029C1.3857 51.4142 0.552094 50.9331 0.552094 50.1631V1.73269C0.552094 0.962749 1.38571 0.481643 2.05237 0.866828Z" fill="currentColor" stroke="currentColor" strokeWidth="1.10417"></path>
      <path d="M52.0518 51.0289L28.7083 37.5415L44.1667 37.5415C44.7765 37.5415 45.2708 37.0472 45.2708 36.4374L45.2708 15.4582C45.2708 14.8484 44.7765 14.354 44.1667 14.354L28.7083 14.354L52.0518 0.866684C52.7185 0.481499 53.5521 0.962608 53.5521 1.73255L53.5521 50.163C53.5521 50.9329 52.7185 51.414 52.0518 51.0289Z" fill="currentColor" stroke="currentColor" strokeWidth="1.10417"></path>
    </svg>
  );
}
      ...
      <div className="noscroll" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '54px 18px 16px', borderBottom: '1px solid var(--line)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
            ...
            <span style={{ fontFamily: 'var(--wordmark)', fontWeight: 700, fontSize: 15, letterSpacing: 1.5, color: T.ink }}>CARDCONOMY</span>
          </div>
