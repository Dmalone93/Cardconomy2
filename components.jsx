      ...
      <div className="noscroll" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '54px 18px 16px', borderBottom: '1px solid var(--line)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
            ...
            <span style={{ fontFamily: 'var(--wordmark)', fontWeight: 700, fontSize: 19, letterSpacing: 1.5, color: T.ink, lineHeight: 1, display: 'block', transform: 'translateY(2px)' }}>CARDCONOMY</span>
          </div>
